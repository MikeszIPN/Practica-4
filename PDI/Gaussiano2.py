...
# Cargar imagenes
fondo = cv2.imread('Fotos/background.jpg', 1)
objeto = cv2.imread('Fotos/objeto.jpg', 1)
...
# Convolusionar la imagen con el filtro gaussiano
blurr = cv2.filter2D(fondo, -1, gauss2)
...
# Resta de imagenes
result = cv2.subtract(fondo, objeto)
# Mostrar resta
...
# AND (A & U) = masked1
masked1 = cv2.bitwise_and(imgBin, objeto)
# Mostrar masked1
...
# AND (F & ~U) = masked2
masked2 = cv2.bitwise_and(imgBin, blurr)
# Mostrar masked2
